...
contract ZombieFeeding is ZombieFactory {
  ...
  function feedAndMultiply(uint _zombieId, uint _targetDna, string memory _species) public {
    ...
    // Check to see if the zombie is ready to feed again by using REQUIRE keyword
    ...
    // Once the zombie is used, trigger cooldown is called to set the cooldown on the zombie.
